...
public class MainActivityFragment extends Fragment {
    ...
    private ArrayAdapter<String> movieDataAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        movieDataAdapter = new ArrayAdapter<String>(
                getActivity(),
                R.layout.list_item_poular_movies,
                R.id.list_item_release_date,
                movieData
        );

        ListView listView = (ListView) rootView.findViewById(R.id.listview_popular_movies);
        listView.setAdapter(movieDataAdapter);
